      ...
      switch (menucatVariant) {
        ...
        case 2: {
          const media = await prepareWAMessageMedia(
            {
              image: fs.readFileSync(config.assets["kurumi2"]),
            },
        ...
        case 5: {
          ...
          const thumbnail = await sharp(fs.readFileSync(config.assets["kurumi"])).resize(300, 300).toBuffer()
          const qOrder = {
                ...
                interactiveMessage: {
                  ...
                  contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                      ...
                      newsletterName: config.saluran?.name || config.bot?.name || "KurumiAI",
                      serverMessageId: 127,
                    },
                  },
                  nativeFlowMessage: {
