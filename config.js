...
const config = {
  info: {
    website: "https://rulz-portofolio.my.id",
    grupwa: "https://chat.whatsapp.com/JqmfuxmegpZ6no93vFr1O3?s=cl&p=a&ilr=1",
  },

  owner: {
    name: "Ayzz", // Nama owner
    number: ["62895321048195"], // Format: 628xxx (tanpa + atau 0)
  },

  session: {
    pairingNumber: "628978518142", // Nomor WA yang akan di-pair, ini penting
  ...
  bot: {
    name: "𝗞𝘂𝗿𝘂𝗺𝗶𝗠𝗱", // Nama bot
    version: "8.0", // Versi bot
    developer: "Ayzz", // Nama developer
  },
  ...
  assets: {
    ...
    "kurumi": "./assets/image/kurumi.png",
    "kurumi2": "./assets/image/kurumiv2.jpg",
    "kurumi3": "./assets/image/kurumiv3.jpg",
    "pp-kosong": "./assets/image/pp-kosong.jpg",
    "kurumiv1": "./assets/video/kurumi.mp4",
    "kurumiv2": "./assets/video/kurumiv2.mp4",
    "kurumiv3": "./assets/video/kurumiv3.mp4",
    "kurumiv4": "./assets/video/kurumiv4.mp4",
    "intro": "./assets/video/intro.mp4",
    "kurumi-mp3": "./assets/audio/kurumi-mp3.mp3",
  ...
  payment: {
    qrisUrl: "",
    methods: [
      { name: "Dana", number: "08978518142", holder: "" },
      { name: "GoPay", number: "08978518142", holder: "" },
      { name: "OVO", number: "08978518142", holder: "" },
      { name: "ShopeePay", number: "08978518142", holder: "" },
    ],
    banks: [],
  ...
  donasi: {
    payment: [
      { name: "Dana", number: "08978518142", holder: "M/K/A" },
      { name: "GoPay", number: "08978518142", holder: "M/KA" },
      { name: "OVO", number: "08978518142", holder: "M/K/A" },
    ],
    links: [
      { name: "Saweria", url: "-" },
      { name: "Trakteer", url: "-" },
  ...
  sticker: {
    packname: "𝗞𝘂𝗿𝘂𝗺𝗶𝗠𝗱", // Nama pack sticker
    author: "Ayzz", // Author sticker
  },

  saluran: {
    id: "120363406203774227@newsletter", // ID saluran (contoh: 120363xxx@newsletter)                          // ID saluran (contoh: 120363xxx@newsletter)
    name: "= ᵕ̈𝙺𝚞𝚛𝚞𝚖𝚒 𝚃𝚑𝚎 𝙳𝚊𝚛𝚔 ᵕ̈=", // Nama saluran
    link: "https://whatsapp.com/channel/0029Vb6XXI13GJP7RMc2ur0S", // Link saluran
  },
  ...
  messages: {
    ...
    rejectCall: "🚫 DILARANG TELPON NOMOR INI",
  },
